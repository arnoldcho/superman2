...
// superman includes.
#include <..\src\script\supermanconsensus.h>
...
int main()
{
    std::cout << "supermanconsensus version: " << supermanconsensus_version() << std::endl;
    ...
    auto op0Result = supermanconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, supermanconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
