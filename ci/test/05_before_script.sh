...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Superman
else
  DOCKER_EXEC echo \> \$HOME/.superman
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/superman/superman/pull/18288#discussion_r433189350 for
  # details.
