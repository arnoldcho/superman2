# Bootstrappable Superman Core Builds

This directory contains the files necessary to perform bootstrappable Superman
Core builds.
...
- 24GB of free disk space on the partition that the Superman Core git repository
  resides in
...
For a Superman Core depends development environment, simply invoke
...
From the top of a clean Superman Core repository:
...
To use dongcarl's substitute server for Superman Core builds after having
