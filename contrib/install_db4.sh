...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the superman repository."
  exit 1
fi
...
# See https://github.com/superman/superman/issues/16064
...
echo 'When compiling supermand, run `./configure` in the following way:'
echo
