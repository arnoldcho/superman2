#!/usr/bin/env python3
# Copyright (c) 2013-2020 The Superman Core developers
...
def main():
    ...
    # Filter out hosts with multiple superman ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple superman ports' % (ip_stats(ips)), file=sys.stderr)
