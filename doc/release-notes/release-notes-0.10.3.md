Superman Core version 0.10.3 is now available from:

  <https://superman.org/bin/superman-core-0.10.3/>
...
(see https://github.com/superman/superman/pull/6793, as well as the 0.11.0
