Superman Core version 0.10.4 is now available from:

  <https://superman.org/bin/superman-core-0.10.4/>
...
- #6953 `43c2789` Split superman-tx into its own package
- #6953 `dfe0d4d` Include superman-tx binary on Debian/Ubuntu
