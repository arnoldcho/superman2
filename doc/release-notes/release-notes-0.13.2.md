Superman Core version 0.13.2 is now available from:

  <https://superman.org/bin/superman-core-0.13.2/>
...
- #8908 `4a974b2` Update superman-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow superman-tx to create v2 transactions (spmdrak)
