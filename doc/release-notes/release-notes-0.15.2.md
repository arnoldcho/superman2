Superman Core version *0.15.2* is now available from:

  <https://supermancore.org/bin/superman-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in superman-tx (TheBlueMatt)
