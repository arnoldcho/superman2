Superman Core version 0.16.1 is now available from:

  <https://supermancore.org/bin/superman-core-0.16.1/>
...
- #12843 `df38b13` Test starting supermand with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure supermand processes are cleaned up when tests end (sdaftuar)
