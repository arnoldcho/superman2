...
Superman Core version 0.19.1 is now available from:

  <https://supermancore.org/bin/superman-core-0.19.1/>
...
From Superman Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Superman Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Superman Core does not yet change appearance when
...
- #17488 fix "supermand already running" warnings on macOS (fanquake)
