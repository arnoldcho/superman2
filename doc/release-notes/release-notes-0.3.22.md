Download URL: https://sourceforge.net/projects/superman/files/Superman/superman-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SPM fee schedule (users still pay 0.01 SPM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #superman00 - #superman99
