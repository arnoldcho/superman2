Superman version 0.5.4 is now available for download at:
http://sourceforge.net/projects/superman/files/Superman/superman-0.5.4/
...
http://gitorious.org/superman/supermand-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Superman-Qt notifications under Growl 1.3.
Increase required age of Superman-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSuperman properly when installing Superman-Qt over it. (Windows)
