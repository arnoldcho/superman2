Superman version 0.6.2 is now available for download at:
http://sourceforge.net/projects/superman/files/Superman/superman-0.6.2/
...
Fixed https://github.com/superman/superman/issues/1065, a bug that
