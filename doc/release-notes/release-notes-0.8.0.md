Superman-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/superman/files/Superman/superman-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Superman
...
New/changed settings (command-line or superman.conf file)
--------------------------------------------------------
