Superman Core version 0.9.2.1 is now available from:

  https://superman.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SPM to 0.01 SPM
...
- Fix "Start superman on system login"
