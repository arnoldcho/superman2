Superman Core version 0.9.4 is now available from:

  https://superman.org/bin/0.9.4/
...
this update is incompatible with the Superman system and could lead to consensus
forks.

Superman Core released binaries from https://superman.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~superman/+archive/ubuntu/superman
- A third-party or self-compiled Superman Core

upgrade to Superman Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
