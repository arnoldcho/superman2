...
This document provides guidelines for internationalization of the Superman Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `superman_en.ts` remains unchanged.
