...
#ifndef SUPERMAN_COMPAT_ASSUMPTIONS_H
#define SUPERMAN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Superman cannot be compiled without assertions."
#endif
...
#endif // SUPERMAN_COMPAT_ASSUMPTIONS_H
