...
#ifndef SUPERMAN_CRYPTO_CHACHA_POLY_AEAD_H
#define SUPERMAN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@superman.
 *
 ...
 *
 * The chacha20-poly1305@superman combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@superman cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@superman are relatively fast in
...
#endif // SUPERMAN_CRYPTO_CHACHA_POLY_AEAD_H
