...
#ifndef SUPERMAN_POLICY_FEERATE_H
#define SUPERMAN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "SPM"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    SPM_KVB,      //!< Use SPM/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from SPM/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SPM_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  SUPERMAN_POLICY_FEERATE_H
