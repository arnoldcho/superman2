...
#ifndef SUPERMAN_QT_GUIUTIL_H
#define SUPERMAN_QT_GUIUTIL_H
...
/** Utility functions used by the Superman Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "superman:" URI into recipient object, return true on successful parsing
