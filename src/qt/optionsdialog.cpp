    ...
    mapper(nullptr)
{
    ...
    ui->supermanAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->supermanAtStartup);
    ...
    ui->supermanAtStartup->setToolTip(ui->supermanAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->supermanAtStartup->setText(ui->supermanAtStartup->text().arg(PACKAGE_NAME));

    ui->openSupermanConfButton->setToolTip(ui->openSupermanConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new SupermanUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->supermanAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSupermanConfButton_clicked()
{
