    ...
    platformStyle(_platformStyle)
{
    ...
    // normal superman address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying superman address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &SupermanAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
