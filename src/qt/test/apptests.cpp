...
//! Entry point for SupermanApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SupermanApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SupermanGUI tests.
void AppTests::guiTests(SupermanGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SupermanGUI::consoleShown, this, &AppTests::consoleTests);
