// Copyright (c) 2015-2020 The Superman Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SupermanAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_superman-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_superman-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_superman-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = SupermanUnits::formatWithUnit(unit, balance, false, SupermanUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    SupermanAmountField* amountInput = receiveCoinsDialog.findChild<SupermanAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_superman-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
