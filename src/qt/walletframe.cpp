...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, SupermanGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &SupermanGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &SupermanGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &SupermanGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &SupermanGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &SupermanGUI::updateWalletStatus);
    connect(gui, &SupermanGUI::setPrivacy, walletView, &WalletView::setPrivacy);
