...
#ifndef SUPERMAN_SCRIPT_STANDARD_H
#define SUPERMAN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a superman address
 */
...
/**
 * Generate a Superman scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // SUPERMAN_SCRIPT_STANDARD_H
