...
#ifndef SUPERMAN_TEST_SCRIPTNUM10_H
#define SUPERMAN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Superman Core 0.10.0, for cross-comparison.
 */
public:
