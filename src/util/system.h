 ...
 */
#ifndef SUPERMAN_UTIL_SYSTEM_H
#define SUPERMAN_UTIL_SYSTEM_H
...
extern const char * const SUPERMAN_CONF_FILENAME;
extern const char * const SUPERMAN_SETTINGS_FILENAME;
