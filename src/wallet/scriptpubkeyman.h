...
#ifndef SUPERMAN_WALLET_SCRIPTPUBKEYMAN_H
#define SUPERMAN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Superman Core wallet was originally a collection of unrelated private
...
#endif // SUPERMAN_WALLET_SCRIPTPUBKEYMAN_H
