...
#ifndef SUPERMAN_WALLET_WALLET_H
#define SUPERMAN_WALLET_WALLET_H
...
public:
     ...
     * on this superman node, and set to 0 for transactions that were created
...
#endif // SUPERMAN_WALLET_WALLET_H
