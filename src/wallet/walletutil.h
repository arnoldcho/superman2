...
#ifndef SUPERMAN_WALLET_WALLETUTIL_H
#define SUPERMAN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! superman from opening the wallet, thinking it was newly created, and
...
#endif // SUPERMAN_WALLET_WALLETUTIL_H
