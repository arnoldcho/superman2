// Copyright (c) 2015-2018 The Superman Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SUPERMAN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define SUPERMAN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // SUPERMAN_ZMQ_ZMQABSTRACTNOTIFIER_H
