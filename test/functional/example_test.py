...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SupermanTestFramework
    pass


class ExampleTest(SupermanTestFramework):
    # Each functional test is a subclass of the SupermanTestFramework class.
    ...
    def custom_method(self):
        ...
        SupermanTestFramework class so other tests can use it."""
