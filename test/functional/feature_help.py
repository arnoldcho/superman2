...
"""Verify that starting superman with -h works as expected."""

from test_framework.test_framework import SupermanTestFramework
from test_framework.util import assert_equal

class HelpTest(SupermanTestFramework):
    ...
    def run_test(self):
        self.log.info("Start superman with -h for help text")
        ...
        self.log.info("Start superman with -version for version information")
        ...
        self.log.info("Start supermand with -fakearg to make sure it does not start")
