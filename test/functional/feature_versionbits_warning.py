...
class VersionBitsWarningTest(SupermanTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because supermand will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
