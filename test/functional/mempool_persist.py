...
By default, supermand will dump mempool on shutdown and
...
class MempoolPersistTest(SupermanTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent supermand from writing mempool.dat to disk. Verify that `savemempool` fails")
