...
class P2PPermissionsTests(SupermanTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].supermanconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].supermanconf, 'w', encoding="utf8") as f:
            f.write(newText)
