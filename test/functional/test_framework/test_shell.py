...
class TestShell:
    """Wrapper Class for SupermanTestFramework.

    The TestShell class extends the SupermanTestFramework
    ...
    class __TestShell(SupermanTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SupermanTestFramework child class.
            self.num_nodes = 1
